    ...
    return Table(
      children: const [
        ...
        TableRow(
          ...
          _SigleCard(color: Colors.pinkAccent,icon: Icons.car_rental,text: 'Grocery'),
        ]),
        TableRow(
          children: [
          _SigleCard(color: Colors.orange, icon: Icons.telegram, text: 'Telegram'),
          _SigleCard(color: Colors.red, icon: Icons.phone, text: 'Phone'),
        ])
      ],
    );
  }
